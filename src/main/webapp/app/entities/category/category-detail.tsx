...
import { getEntity as getCategory } from './category.reducer';
import { getEntities as getPosts } from '../post/post.reducer';
...
export const CategoryDetail = (props: ICategoryDetailProps) => {
  ...
  useEffect(() => {
    ...
    props.getPosts(paginationState.activePage - 1, paginationState.itemsPerPage, `${paginationState.sort},${paginationState.order}`, categoryId);
