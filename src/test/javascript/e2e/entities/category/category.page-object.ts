...
export class CategoryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('newsApp.category.delete.question'));
...
export default class CategoryComponentsPage {
  ...
  async deleteCategory() {
    ...
    expect(await categoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/newsApp.category.delete.question/);
