...
import { CreatePostArgs, UpdatePostArgs } from 'app/graphql';
import { CreatePostDocument, DeletePostDocument, GetPostDocument, GetPostsDocument, UpdatePostDocument } from 'app/entities/post/post.gql';
